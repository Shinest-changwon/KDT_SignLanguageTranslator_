...
for first_folder in first_folders:
    ...
    for second_folder in second_folders:
        ...
        json_file_path.append(basic_path + '/' + first_folder + '/morpheme/' + second_folder) # 총 49개 폴더
print(len(json_file_path)) # 49개(폴더)

# csv로 저장
with open('morpheme_train.csv', 'w', newline='',encoding='utf-8') as csv_file:
...
for path in json_file_path:
    ...
    for json_path in json_file_list:
        with open(json_path, 'r') as f:
            ...
            with open('morpheme_train.csv', 'a', newline='',encoding='utf-8') as csv_file:
