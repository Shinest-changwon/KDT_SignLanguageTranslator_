...
class Model(nn.Module):
    def __init__(self, num_class=33, num_point=27, num_person=1, groups=16, block_size=41, graph= 'graph.sign_27.Graph', graph_args={'labeling_mode': 'spatial'}, in_channels=3):
